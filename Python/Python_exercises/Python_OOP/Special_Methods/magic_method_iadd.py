"""
This programm allowed us to add two classes in unit of lengths.
By default it is initialized in the unit of meter and 
the result is given in the same unit of the first class given.
Example: Length(5,"yd") + Length(15, "mm") the result is given in "yd"
